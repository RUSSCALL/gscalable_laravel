            ...
            <form class="gst_login_form" method="POST" action="{{route('register')}}">
                ...
                <div class="gst_login_form_group">
                    ...
                    <div class="gst_login_password_input_wrapper">
                        <input type="password" name="password" id="register-password" class="gst_login_input" placeholder="••••••••" required data-password-input>
                        <button type="button" class="gst_login_eye_icon" data-password-toggle aria-controls="register-password" aria-label="Show password" aria-pressed="false">
                            <i class="bi bi-eye"></i>
                        </button>
                    @error('password')
                        <span class="gst-form-error-message">
                ...
                <div class="gst_login_form_group">
                    ...
                    <div class="gst_login_password_input_wrapper">
                        <input type="password" name="password_confirmation" id="register-password-confirmation" class="gst_login_input" placeholder="••••••••" required data-password-input>
                        <button type="button" class="gst_login_eye_icon" data-password-toggle aria-controls="register-password-confirmation" aria-label="Show password" aria-pressed="false">
                            <i class="bi bi-eye"></i>
                        </button>
