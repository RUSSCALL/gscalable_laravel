        ...
        <div class="application-form-container">
          <form action="{{ route('jobapplication.store') }}" method="POST" enctype="multipart/form-data" class="application-form">
            ...
            <div class="application-section mb-4">
              ...
              <div class="row">
                <div class="col-md-6 mb-3">
                  ...
                  <input type="url" class="form-control" id="linkedin_url" name="linkedin_url" placeholder="https://linkedin.com/in/yourusername">
                </div>
                <div class="col-md-6 mb-3">
            ...
            <div class="application-section mb-4">
              ...
              <div class="mb-3">
                <textarea class="form-control" id="cover_letter" name="cover_letter" rows="6" placeholder="Why are you interested in this position? What makes you a good fit?"></textarea>
              </div>
            </div>
